function Blog() {
  return (
    <section className="container-xl mt-5">
      <h2 className="text-center fw-bold">Nuestro Blog!</h2>
      ...
      <div className="row mt-5">
        <div className="col-md-6 col-lg-4 mb-4">
          <div className="card h-100">
            ...
            <div className="card-body d-flex flex-column">
              <h3 className="text-black fw-normal fs-4 fw-bold">
        ...
        <div className="col-md-6 col-lg-4 mb-4">
          <div className="card h-100">
            ...
            <div className="card-body d-flex flex-column">
              <h3 className="text-black fw-normal fs-4 fw-bold">
                Crea tu espacio de trabajo ideal – No es difícil
              </h3>
              <p>
                ¿ DUDAS ? escribenos por WhatsApp Como verás en el video ??, la
                decoración es clave para darle tu toque personal a tu home
                office.
              </p>
              <a
                className="mt-auto btn btn-primary d-block text-white btn-prod"
